...
//                BT.logger.error(String.valueOf(!BT.player_personality.getBooleanValue(playerUsername, true)));
//                if(!BT.player_personality.getBooleanValue(playerUsername, true))
//                    player.(Component.text("§a§l您以关闭聊天转发，q群可能无法接收到您发送的信息，使用/bt chat on开启此功能"));
            }
